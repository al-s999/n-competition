...
const statusConfig: Record<string, { label: string; color: string }> = {
  ...
  registration: { label: "Pendaftaran", color: "bg-blue-500 hover:bg-blue-600" },
  ongoing: { label: "Berjalan", color: "bg-yellow-500 hover:bg-yellow-600 text-black" },
  finished: { label: "Selesai", color: "bg-green-500 hover:bg-green-600" },
  registered: { label: "Terdaftar", color: "bg-gray-400 hover:bg-gray-500" },
  confirmed: { label: "Dikonfirmasi", color: "bg-blue-400 hover:bg-blue-500" },
  paid: { label: "Lunas", color: "bg-green-400 hover:bg-green-500 text-black" },
  qualified: { label: "Lolos", color: "bg-purple-500 hover:bg-purple-600" },
  final: { label: "Final", color: "bg-indigo-500 hover:bg-indigo-600" },
  pending: { label: "Menunggu", color: "bg-yellow-500 hover:bg-yellow-600 text-black" },
  verified: { label: "Terverifikasi", color: "bg-green-500 hover:bg-green-600" },
