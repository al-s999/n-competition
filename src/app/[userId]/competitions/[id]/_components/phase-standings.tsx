            ...
            <div className="space-y-3">
              {filteredGroups
                .map((group) => {
                  ...
                  return (
                    <div key={group.id} className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden dark:bg-slate-950 dark:border-slate-800 dark:shadow-none">
                      {/* Group Header */}
                      <div
                        className="flex items-center justify-between p-4 cursor-pointer select-none hover:bg-slate-50 transition-colors dark:hover:bg-slate-900/80"
                        ...
                        <div className="flex items-center gap-2">
                          {group.stage !== "Champion" && (
                            <Button size="sm" variant="outline" className="h-7 text-xs gap-1 font-medium bg-indigo-50/50 hover:bg-indigo-100/50 text-indigo-700 dark:bg-indigo-500/10 dark:hover:bg-indigo-500/20 dark:text-indigo-400 border-indigo-200 dark:border-indigo-800"
                              ...
                              <BookOpen className="h-3 w-3" />Assign Quiz</Button>
                          )}
                          <Button size="sm" variant="outline" className="h-7 text-xs gap-1"
                            onClick={(e) => { e.stopPropagation(); setAssignDialog(group); }}>
                            <UserPlus className="h-3 w-3" />Assign Finalist</Button>
